                  ...
                  <form class="mx-1 mx-md-4" method="post" class="form">
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="name_user">Your Name</label>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="passwd_user">Password</label>
                        <input type="password" id="passwd_user" name="passwd_user" class="form-control" />
                      </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <button type="button" class="btn btn-primary btn-lg" id="register" name="register">Register</button>
                    </div>
