<?php
    ...
    $fullname   = addslashes($_POST['user_fullname']);
    $birthday   = addslashes($_POST['user_birth']);
    $gender     = addslashes($_POST['user_gender']);
    ...
    if (mysql_num_rows(mysql_query("SELECT user_name FROM tbl_user WHERE user_name='$username'")) > 0){
    ...
    if (mysql_num_rows(mysql_query("SELECT user_email FROM tbl_user WHERE user_email='$email'")) > 0)
    {
